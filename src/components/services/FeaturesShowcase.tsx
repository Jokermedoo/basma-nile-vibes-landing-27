...
const FeaturesShowcase = () => {
  const features = [
    { icon: Crown, title: "خدمة ملكية", desc: "تجربة VIP استثنائية", bg: "from-yellow-400 to-orange-400" },
    { icon: Sparkles, title: "أجواء ساحرة", desc: "تفاصيل لا تُنسى", bg: "from-pink-400 to-purple-400" },
    { icon: Gift, title: "عروض حصرية", desc: "أسعار مميزة للأعضاء", bg: "from-purple-400 to-indigo-400" },
    { icon: Camera, title: "تصوير مجاني", desc: "ذكريات خالدة", bg: "from-blue-400 to-cyan-400" },
    { icon: Award, title: "جودة عالمية", desc: "معايير عالمية للخدمة", bg: "from-green-400 to-emerald-400" },
    { icon: Zap, title: "استجابة فورية", desc: "خدمة عملاء 24/7", bg: "from-orange-400 to-red-400" }
  ];
