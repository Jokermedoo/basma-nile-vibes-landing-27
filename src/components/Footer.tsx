      ...
      <div className="container mx-auto px-6 py-16 text-center relative z-10">
        <div className="mb-12">
          <div className="flex justify-center items-center gap-4 mb-6">
            ...
            <h3 className="text-4xl font-bold gradient-text-advanced dancing-script">
              بسمة نبيل - خدمات VIB
            </h3>
            <Gem className="w-12 h-12 text-purple-400 wiggle" />
          </div>
          <p className="text-gray-300 max-w-3xl mx-auto text-xl leading-relaxed">
            نحن ملتزمون بتقديم أفضل الخدمات وأجمل التجارب لعملائنا الكرام مع ضمان الجودة والتميز في كل التفاصيل
          </p>
        </div>
