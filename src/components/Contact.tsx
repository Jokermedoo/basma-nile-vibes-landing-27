...
import { MessageCircle, Phone, Clock, Star, Send, MapPin, Mail, Instagram, Heart, Sparkles, Crown, Zap } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center text-white mb-20">
            ...
            <p className="text-2xl opacity-90 mb-12 max-w-4xl mx-auto leading-relaxed">
              تواصل معي الآن واحجز تجربتك المميزة - نحن هنا لجعل كل لحظة لا تُنسى مع خدمة VIP استثنائية
            </p>
          </div>
            ...
            <div className="glass-effect rounded-3xl p-12 border border-white/30 hover-lift-intense magnetic">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  >
                    <option value="" className="bg-gray-800 text-white">اختر الخدمة المطلوبة</option>
                    <option value="مراكب نيلية VIP" className="bg-gray-800 text-white">🚢 مراكب نيلية VIP</option>
                    <option value="سهرات وديسكو" className="bg-gray-800 text-white">🎉 سهرات وديسكو</option>
                    <option value="حفلات ومباريات" className="bg-gray-800 text-white">🎵 حفلات ومباريات</option>
                    <option value="نايت كلاب" className="bg-gray-800 text-white">🕺 نايت كلاب</option>
                    <option value="استشارة عامة" className="bg-gray-800 text-white">💬 استشارة عامة</option>
                  </select>
                </div>
                <div>
                  <textarea
            ...
            <div className="space-y-8">
              <div className="glass-effect rounded-3xl p-10 border border-white/30 hover-lift-intense magnetic transform hover:rotate-1 transition-all duration-500">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-white gradient-text-advanced">واتساب VIP</h3>
                </div>
              ...
              <div className="glass-effect rounded-3xl p-10 border border-white/30 hover-lift-intense magnetic transform hover:rotate-1 transition-all duration-500">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-white gradient-text-advanced">اتصال مباشر</h3>
                </div>
                <p className="text-xl mb-8 text-white/90 leading-relaxed">
              ...
              <div className="glass-effect rounded-3xl p-10 border border-white/30">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-white gradient-text-advanced">أوقات العمل</h3>
                </div>
                <div className="space-y-3 text-white/90 text-xl">
                  <p><strong className="text-white">الأحد - الخميس:</strong> 9:00 ص - 12:00 م</p>
                  <p><strong className="text-white">الجمعة - السبت:</strong> 10:00 ص - 2:00 ص</p>
          ...
          <div className="text-center">
            <div className="glass-effect rounded-3xl p-16 border border-white/30">
              <h3 className="text-5xl font-bold text-white mb-8 dancing-script neon-text">🌟 جروب VIB المميز 🌟</h3>
              <div className="flex justify-center items-center gap-3 mb-8">
                {[1,2,3,4,5].map((i) => (
                  <Star key={i} className="w-10 h-10 text-yellow-300 fill-current animate-pulse" style={{animationDelay: `${i * 0.3}s`}} />
                ))}
              </div>
              <p className="text-2xl text-white/90 mb-12 max-w-4xl mx-auto leading-relaxed">
                انضم إلى مجموعتنا المميزة واستمتع بأفضل العروض والخدمات الحصرية مع تجربة VIP استثنائية لا تُنسى
              </p>
