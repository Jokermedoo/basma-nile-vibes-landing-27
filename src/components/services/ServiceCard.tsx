    ...
    >
      <div className="morph-card p-8 h-full hover-lift-intense magnetic transition-all duration-500">
        ...
        <div className="relative z-10">
          ...
          <div className={`absolute -top-3 -right-3 w-10 h-10 bg-gradient-to-r ${service.gradient} rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg ${isHovered ? 'animate-bounce' : ''}`}>
            {index + 1}
          </div>
        </div>
      </div>
