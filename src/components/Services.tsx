  ...
  const services = [
    {
      ...
      description: "استمتعي برحلات نيلية فاخرة على أجمل مراكب القاهرة مع خدمة 5 نجوم وإطلالات ساحرة على النيل",
      features: ["مراكب فاخرة مجهزة بالكامل", "عشاء فاخر وبوفيه مفتوح", "موسيقى حية ودي جي محترف", "خدمة شخصية مميزة 24/7"],
    ...
    },
    {
      ...
      description: "أحلى السهرات في أفخم الأماكن مع أجواء رائعة وموسيقى صاخبة ومشروبات مميزة",
      features: ["أفخم النايت كلابز بالقاهرة", "دي جي عالمي ومحلي مشهور", "كوكتيلات ومشروبات مميزة", "طاولات VIP حصرية"],
    ...
    },
    {
      ...
      description: "حجوزات حفلات النجوم ومشاهدة المباريات المهمة في أفضل الأماكن مع جو حماسي",
      features: ["حفلات النجوم والمشاهير", "مشاهدة المباريات المهمة", "مهرجانات وفعاليات خاصة", "أماكن مميزة بإطلالات رائعة"],
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed rubik-font">
            احجزي معانا أحلى السهرات والرحلات النيلية وشاهدي أهم المباريات والحفلات مع جروب VIB المميز
          </p>
        </div>
